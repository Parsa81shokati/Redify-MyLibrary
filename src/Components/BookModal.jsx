  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm z-50 ">
      <div className="relative bg-white w-[300px] sm:w-[500px] md:w-[900px] md:max-h-[80vh] py-3 rounded-lg md:rounded-xl shadow-lg flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="overflow-y-auto px-4 sm:px-0 mt-5 md:mt-9 ">
              ...
              {book.description.length > 100 && (
                <button
                  ...
                  className="mb-5 text-black text-[10px] md:text-lg hover:underline"
                >
        ...
        <button
          onClick={onClose}
          className="absolute top-0 h-5 w-5 md:h-10 md:w-10 right-0 bg-black text-white text-[10px] md:px-4 md:py-2 rounded-sm hover:bg-gray-700"
        >
          X
        </button>
      </div>
