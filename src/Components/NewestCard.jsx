  ...
  return (
    <div className=" relative flex flex-col items-center w-28 sm:w-35 lg:w-40 h-50 sm:h-60 lg:h-70 border border-none rounded-2xl hover:shadow-md  transition [box-shadow:0_-4px_6px_rgba(0,0,0,0.15)] bg-gradient-to-r from-blue-100 to-blue-50 mt-5 md:mt-8 mb-4 md:mb-7 ">
      ...
      <div className="flex flex-col mt-2 lg:mt-5">
        ...
        <div className="absolute flex justify-center items-center w-10 md:w-13 lg:w-11 h-10 sm:h-10 md:h-13 lg:h-11 bg-[#c7e1ff] dark:bg-[#071d34] transition-colors duration-500 -bottom-3 md:-bottom-4 -right-4 md:-right-3 rounded-tl-xl ">
          <button
            onClick={() => onOpen(book)}
